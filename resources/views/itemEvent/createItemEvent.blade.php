...
<div id="event-create-container" class="col-md-6 offset-md-3">
  <div class="shadow-lg p-3 mb-5 bg-white rounded">
    ...
    @endif
      <div class="shadow-none p-3 mb-5 bg-light rounded"><h1>Novo item</h1></div>  
      <form  name="formEdit" enctype="multipart/form-data">
      @csrf
      @method('POST')
      <div class="form-group">
        <label for="title">Item:</label><tag class="font-red">*</tag>
        <input type="text" class="form-control" id="description" name="description" placeholder="Item" value="" required>
      </div>
      <div class="form-group">
  ...
  $(function(){
      ...
      $.ajax({
        ...
        success: function(response){
          ...
          $('.messageBox').html('Item criado com sucesso!');
          $('#description').val("");
          $('#active').val("");
          setTimeout(function() {
            $('#alerta').fadeOut('fast');
