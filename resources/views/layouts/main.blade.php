          ...
          <ul class="menu-list">
            ...
            <li class="sublinhado" id="autenticado">
              ...
              <p><?php  
                ...
                ?> 
                    <i class="bi bi-person-circle"><b>{{$nome}}</b></i>
              <?php
                  }
                  ?>
              </p>
                 <a href="/logout" class="nav-link" onclick="event.preventDefault();this.closest('form').submit();"><h6>{{ $registro[0]->description }}  &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;  <i class="bi bi-box-arrow-right">Sair</h6></i></a>
              </form>  
            </li>
            @endauth
          </ul>
