    ...
    public static function buscar_mensagens($id = null) {
        ...
        if($id != null){
            ...
            $registro = DB::table('message_classes')
                    ...
                    ->select('message_classes.id as id','message_classes.classe_id as classe_id','users.id as user_id','users.name as name','message_classes.created_at as data_envio','message_classes.message as message')
