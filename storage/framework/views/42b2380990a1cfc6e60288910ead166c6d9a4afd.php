<?php $attributes = $attributes->exceptProps(['title' => __('Confirmar Senha'), 'content' => __('Para sua segurança, confirme sua senha para continuar.'), 'button' => __('Confirm')]); ?>
<?php foreach (array_filter((['title' => __('Confirmar Senha'), 'content' => __('Para sua segurança, confirme sua senha para continuar.'), 'button' => __('Confirm')]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php if (! $__env->hasRenderedOnce('a8c95c0f-7ff7-43b6-a6e2-e19a625ee265')): $__env->markAsRenderedOnce('a8c95c0f-7ff7-43b6-a6e2-e19a625ee265'); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH E:\laragon\www\TCC\jcevents\vendor\laravel\jetstream\src/../resources/views/components/confirms-password.blade.php ENDPATH**/ ?>