  ...
  <?php if(!isset($_GET['search'])): ?>
    ...
    <div data-slide="slide" class="slide">
      ...
      <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($event->spotlight != null): ?>
          <img src="/img/events/<?php echo e($event->image); ?>" width="500" height="400" alt="Img 1">
        <?php endif; ?>
...
<div id="events-container" class="col-md-12">
    <?php if(isset($userFacebook)): ?>
        <p>Bem vindo: <?php echo e($userFacebook->name); ?></p>
    <?php endif; ?>
    <?php if($search): ?>
    <h2>Aproximadamente: <?php echo e(count($events)); ?> resultado(s) para: <?php echo e($search); ?></h2>
    <?php else: ?>
    ...
    <div id="cards-container" class="row">
        ...
        <div class="card col-md-3">
            ...
            <div class="card-body">
                ...
                <a href="/event/<?php echo e($event->id); ?>" class="btn btn-primary">Saber mais</a>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\TCC\jcevents\resources\views/welcome.blade.php ENDPATH**/ ?>